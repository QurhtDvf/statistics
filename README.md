...
## 4. 構成
**第1章 確率論の基礎**
- 1.1 [標本空間と事象](https://github.com/QurhtDvf/statistics/tree/main/sample_space_and_events)
...
**第9章 仮説検定**
- 9.1 仮説検定の枠組み（帰無仮説・対立仮説）
- 9.2 第1種・第2種の過誤と検出力
- 9.3 ネイマン・ピアソンの補題
- 9.4 尤度比検定
- 9.5 正規母集団の検定（z検定・t検定）
- 9.6 χ²検定・F検定
- 9.7 p値と多重検定
